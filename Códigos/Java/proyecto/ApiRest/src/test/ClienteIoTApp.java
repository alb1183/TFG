...
public class ClienteIoTApp {
	...
	public static String usuarioID = "sensor";
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Logueado correctamente -> " + respuesta);
			
			// Genero datos cada diez segundos durante dos minutos
			for(int i=1; i <= 12; i++) {
				double temp = 50.0 + Math.sin(i*4)*50;
				double pres = 1.0 + Math.sin(i)*10;
				double niv = 200.0 + Math.sin(i*2)*200;				
				String datos = "{\\\"sensor\\\": \\\"sensor-01\\\", \\\"temperatura\\\": \\\""+temp+"\\\", \\\"presion\\\": \\\""+pres+"\\\", \\\"nivel\\\": \\\""+niv+"\\\"}";
